    ...
    public static void main(String[] args) throws IOException, MessagingException {
        ...
        Session session= Session.getInstance(props,new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("daxue0929@qq.com","irlupapecngbecig");
            }
        ...
        //    真正要发送时, 邮箱必须是真实有效的邮箱。
        message.setFrom(new InternetAddress("daxue0929@qq.com", "tools_site", "UTF-8"));

        // 3. To: 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress("2365696858@qq.com", "网站消息提醒", "UTF-8"));
//        //    To: 增加收件人（可选）
...
//        message.setRecipient(MimeMessage.RecipientType.BCC, new InternetAddress("ff@receive.com", "USER_FF", "UTF-8"));
        ...
        transport.connect("daxue0929@qq.com","irlupapecngbecig");
